...
Scenario Outline: Retrieve a specific project by project id (Normal Flow)
...
Scenario Outline: User requests to retrieve a project that does not exist (Error Flow)
